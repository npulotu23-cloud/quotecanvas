...
export function EditorControlsDesktop({ style, overrides, updateOverride, photoAnalysis, activeTab, setActiveTab, image, words, author, selectedStyleId, onSelectStyle, fontsReady }) {
  return (
