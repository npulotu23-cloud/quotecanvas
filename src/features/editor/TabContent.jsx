...
export function TabContent({ activeTab, style, overrides, updateOverride, photoAnalysis, compact = false, image, words, author, selectedStyleId, onSelectStyle, fontsReady }) {
